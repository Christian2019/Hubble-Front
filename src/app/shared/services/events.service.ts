...
export class EventsService {
  ...
  fetch_pending(): Observable<EventCard[]> {
    return this.httpClient.get<EventCard[]>(
      environment.apiUrl + "event/status/pendente"
    );
  }
  ...
  updateCategory(idCategory: string, idUser: string) {
    ...
    console.log(url);
    this.httpClient
      .post<string>(url, { idCategoria: idCategory })
  ...
  getParticipatedEvents() {
    ...
    const endpoint =
      environment.apiUrl +
      "user/events/participatedEvents/" +
      this.currentUser.id;
  ...
  getFavoriteEvent(idUser: string, event: string): Promise<any> {
    return this.httpClient
      .post<any>(environment.apiUrl + "user/favoritado/" + idUser, {
        idEvent: event
      })
      .toPromise()
  ...
  favoriteEvent(idUser: string, event: string): Promise<any> {
    return this.httpClient
      .put<any>(environment.apiUrl + "user/favoritar/" + idUser, {
        idEvent: event
      })
      .toPromise()
      .then((resposta: Response) => resposta);
  }
  // TODO Adicionar metodo de cancelar evento
  AprovarEvent(event: string): Promise<any> {
    return this.httpClient
      .put<any>(environment.apiUrl + "event/status/aprovado/" + event, {})
      .toPromise()
      .then((resposta: Response) => resposta);
  }
  ...
  ReproveEvent(event: string): Promise<any> {
    return this.httpClient
      .put<any>(environment.apiUrl + "event/status/rejeitado/" + event, {})
      .toPromise()
      .then((resposta: Response) => resposta);
  }
  ...
  getConfirmedEvent(idUser: string, event: string): Promise<any> {
    return this.httpClient
      .post<any>(environment.apiUrl + "user/confirmado/" + idUser, {
        idEvent: event
      })
      .toPromise()
      .then((resposta: any) => resposta);
  ...
  confirmEvent(idUser: string, event: string): Promise<any> {
    return this.httpClient
      .post<any>(environment.apiUrl + "user/confirmar/" + idUser, {
        idEvent: event
      })
      .toPromise()
      .then((resposta: Response) => resposta);
  }
  //Mudar para cancel e alterar implementação
  cancel(id: string): Promise<any> {
    return this.httpClient
      .delete(environment.apiUrl + "status/cancelado/" + id)
      .toPromise()
      .then(() => null)
      .catch();
  }
  updateEvent(idEvent: string, event: Event): Promise<any> {
    return this.httpClient
      .put<any>(environment.apiUrl + "event/" + idEvent, event)
      .toPromise()
      .then((resposta: Response) => resposta);
  }
  ...
  update_toAdmin(email: string) {
    ...
    return this.httpClient.post(
      environment.apiUrl + "user/criarAdmin/" + email,
      {}
    );
  }
}
